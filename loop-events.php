...
<div id="events-loop" class="loop events-loop" data-view="grid">
	<div class="list-header">
		...
		<div class="col col-3 col-header partner"><span>Partner</span></div>
				...
				<div class="popup-content">
					<div class="toggles">
						...
						foreach( $times_of_day as $time_of_day ):
							echo '<div class="toggle filter active" data-filter="time-of-day" data-slug="'.$time_of_day->slug.'">';
		...
		echo '<div class="row day day-loop'.$past.'" data-date="'.$date_str.'">';
			echo '<div class="col col-12">';
				echo '<div class="date-header">';
					...
					echo '<div class="placeholder">'.$date_format.'</div>';
				echo '</div>';
			echo '</div>';
			$day_int++;
		echo '</div>';
